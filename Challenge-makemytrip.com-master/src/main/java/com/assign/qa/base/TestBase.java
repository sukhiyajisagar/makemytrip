...
public class TestBase {
	...
	public void driverInitialization() {
		...
		System.setProperty("webdriver.chrome.driver", "src\\main\\java\\com\\assign\\qa\\driver\\chromedriver.exe");
	...
	public void readPropertyFile() {
		try {
			...
			FileInputStream propFile = new FileInputStream(currentDir+"\\src\\main\\java\\com\\assign\\qa\\config\\config.properties");
			prop = new Properties();
			prop.load(propFile);
